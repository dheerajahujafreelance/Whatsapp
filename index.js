...
async function startBot() {
    ...
    sock.ev.on('connection.update', (update) => {
        ...
        if (connection === 'open') console.log('✅ DAapp AI IS ONLINE!');
        if (connection === 'close') {
    ...
    sock.ev.on('messages.upsert', async (m) => {
        ...
        if (orderStates[sender]?.step === 'WAITING_FOR_ADDRESS') {
            ...
            // Match the exact format of your DAapp Admin Panel
            const DAappOrder = {
                userId: "whatsapp_" + customerWaNumber,
                userEmail: "whatsapp@DAapp.com",
        ...
        // --- DYNAMIC MENU FEATURE ---
            ...
            let menuMessage = "🍔 *DAapp LIVE MENU* 🍕\n\n";
